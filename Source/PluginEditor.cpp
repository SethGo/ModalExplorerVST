    ...
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    keyKnobLabel.setColour (juce::Label::ColourIds::textColourId, orangePastel);
    ...
    keyRomanNumLabel.setColour (juce::Label::ColourIds::textColourId, orangePastel);
    ...
    noteAltLabel2.setColour (juce::Label::ColourIds::textColourId, orangePastel);
    ...
    noteAltLabel3.setColour (juce::Label::ColourIds::textColourId, orangePastel);
    ...
    noteAltLabel4.setColour (juce::Label::ColourIds::textColourId, orangePastel);
    ...
    noteAltLabel5.setColour (juce::Label::ColourIds::textColourId, orangePastel);
    ...
    noteAltLabel6.setColour (juce::Label::ColourIds::textColourId, orangePastel);
    ...
    noteAltLabel7.setColour (juce::Label::ColourIds::textColourId, orangePastel);
    ...
    negHarmBtn.setColour (juce::ComboBox::outlineColourId, orangePastel);
    ...
    rbModeLabel.setLookAndFeel (&customLookAndFeel);
    ...
    invKnobLabelS.setLookAndFeel (&customLookAndFeel);
    ...
    invKnobLabelA.setLookAndFeel (&customLookAndFeel);
    ...
    invKnobLabelT.setLookAndFeel (&customLookAndFeel);
    ...
    invKnobLabelB.setLookAndFeel (&customLookAndFeel);
    ...
    oscSelectComboS.setLookAndFeel (&customLookAndFeel);
    ...
    oscSelectComboA.setLookAndFeel (&customLookAndFeel);
    ...
    oscSelectComboT.setLookAndFeel (&customLookAndFeel);
    ...
    oscSelectComboB.setLookAndFeel (&customLookAndFeel);
    oscSelectComboB.setSelectedId (1);
    oscSelectComboB.addListener (this);
    
    addAndMakeVisible (oscTypeLabel);
    oscTypeLabel.setLookAndFeel (&customLookAndFeel);
    ...
    oscMixLabel.setLookAndFeel (&customLookAndFeel);
    ...
    filterLabelA.setLookAndFeel (&customLookAndFeel);
    ...
    filterLabelD.setLookAndFeel (&customLookAndFeel);
    ...
    filterLabelS.setLookAndFeel (&customLookAndFeel);
    ...
    filterLabelR.setLookAndFeel (&customLookAndFeel);
    ...
    filterTitleLabel.setLookAndFeel (&customLookAndFeel);
    ...
    ampLabelA.setLookAndFeel (&customLookAndFeel);
    ...
    ampLabelD.setLookAndFeel (&customLookAndFeel);
    ...
    ampLabelS.setLookAndFeel (&customLookAndFeel);
    ...
    ampLabelR.setLookAndFeel (&customLookAndFeel);
    ...
    ampTitleLabel.setLookAndFeel (&customLookAndFeel);
    ...
    resLabel.setLookAndFeel (&customLookAndFeel);
    ...
    cuttoffLabel.setLookAndFeel (&customLookAndFeel);
    ...
    outputLabel.setLookAndFeel (&customLookAndFeel);
...
void ModalExplorerVSTAudioProcessorEditor::toggleNeg()
{
    if (audioProcessor.negHarmMode == false)
    {
        ...
        negHarmBtn.setColour (juce::TextButton::textColourOnId, darkBlue);
    ...
    {
        negHarmBtn.setToggleState (false, juce::NotificationType::dontSendNotification);
        negHarmBtn.setColour (juce::TextButton::textColourOffId, brightBlue);
...
void ModalExplorerVSTAudioProcessorEditor::resized()
{
    ...
    int noteAltSliderX = 205;
    int noteAltSliderY = 72;
    
    // Extra features (Neg-Harm, RB mode, Glide)
